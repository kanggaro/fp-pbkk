  ...
  <div class="container container-fluid">
    ...
    <!-- content -->
      ...
      <div class="mb-3 row">
              ...
              <div class="col-sm-10">
                <input type="text" name="firstname" value="User" class="form-control-plaintext" placeholder="firstname">
              </div>
      </div>
      <div class="mb-3 row">
              <strong class="col-sm-2 col-form-label">Last Name:</strong>
              <div class="col-sm-10">
                <input type="text" name="lastname" value="User" class="form-control-plaintext" placeholder="lastname">
              </div>
      </div>
      <div class="mb-3 row">
              <strong class="col-sm-2 col-form-label">Email:</strong>
              <div class="col-sm-10">
                <input type="email" name="email" value="user@example" class="form-control-plaintext" placeholder="email">
              </div>
      </div>
      <div class="mb-3 row">
              <strong class="col-sm-2 col-form-label">Phone Number:</strong>
              <div class="col-sm-10">
                <input type="number" name="phonenumber" value="081111111111" class="form-control-plaintext" placeholder="phonenumber">
              </div>
      </div>
    <!-- endsection content -->
    </div>
