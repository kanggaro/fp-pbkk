  ...
  <div class="container container-fluid">
    ...
    <form action="" method="POST">
      ...
      <div class="mb-3 row">
          ...
          <div class="col-sm-10">
              <input type="number" name="release" class="form-control" placeholder="release">
          </div>
      </div>
      <div class="mb-3 row">
      ...
      <div class="mb-3 row">
          <strong class="col-sm-2 col-form-label">Mystery:</strong>
          <div class="col-sm-10">
              <input type="text" name="mystery" class="form-control" placeholder="mystery">
          </div>
      </div>
      <div class="mb-3 row">
